...
$page_subtitle="Add Blog Cagetory";include("header.php");include("left-nev.php");
?>
      ...
      <div class="row">
		...
		<section class="col-lg-12 connectedSortable">
          <!-- TO DO List -->          
            ...
            <div class="box-body">              <!--<form method="post" enctype="multipart/form-data">-->               <?php echo form_open_multipart('sitepanel/addblogcategory');?>			   			   <?php 			   if(form_error('body'))			   {				echo form_error('body');   			   }			   ?>
			  Category Title <span style="color:red;">*</span>
                <div class="form-group">
                  <input type="text" class="form-control" name="blog_category" value="<?php echo set_value('blog_category'); ?>" placeholder="Category Title">                  <div style="color:red"><?php echo form_error('blog_category');?></div>
                </div>
