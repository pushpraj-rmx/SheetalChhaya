        ...
        <div class="col-xs-12">
          ...
          <div class="box">
            ...
            <div class="box-header">
             ...
             <!--<button type="button" class="btn bg-navy margin" onclick="window.location.href='<?php //echo base_url('sitepanel/addpage') ?>'">Add Page</button>-->
...
<?php endif; ?>
              ...
              <table id="example1" class="table table-bordered table-striped">
				...
				foreach($pagecontent as $contents):
				if($pgnum>1)
				{
				$pg=$pgnum*10;
				$sn=$pg+$pi;	
                ...
                <tr>
				 ...
				 <td><?php echo $sn;?></td>
                  ...
                  <td><?=$contents['pg_name'];?></td>

                 <td><?=$contents['pg_url'];?></td>

                 <td><img src="<?php echo base_url().'upload/'.$contents['image']; ?>" style="height:50px;width:100px;" /></td>
                  <td>
                                  <?php if ($contents['pg_status'] == 'Active') : ?>
									<a href="<?php echo base_url('sitepanel/') ?>pgstatus/<?=$contents['pg_id'];?>/Inactive"><span class="label label-info">Active</span></a>
                                    <?php else: ?>
                                     <a href="<?php echo base_url('sitepanel/') ?>pgstatus/<?=$contents['pg_id'];?>/Active"><span class="label bg-red">Inactive</span></a>
                                    <?php endif ?>
									</td>

				  

                  <td><a href="<?php echo base_url('sitepanel/') ?>pgedit/<?=$contents['pg_id'];?>">
...
<!--
                  ...
                  <a href="<?php echo base_url('sitepanel/') ?>pgdelete/<?=$contents['pg_id'];?>" onclick="return confirm('Are you sure you want to delete this ?')">
