              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tr>
                 ...
                 <td><img src="<?php echo base_url().'upload/gallery/'.$contents['image']; ?>" style="height:50px;width:100px;" /></td>
                  <td>                                  <?php if ($contents['pg_status'] == 'Active') : ?>									<a href="<?php echo base_url('sitepanel/') ?>galpgstatus/<?=$contents['gallery_id'];?>/Inactive"><span class="label label-info">Active</span></a>                                    <?php else: ?>                                     <a href="<?php echo base_url('sitepanel/') ?>galpgstatus/<?=$contents['gallery_id'];?>/Active"><span class="label bg-red">Inactive</span></a>                                    <?php endif ?>									</td>
